...
public class JazzCash extends AppCompatActivity {
    ...
    private final String Jazz_MerchantID      = "MC19371";
    private final String Jazz_Password        = "48uxy78b3b";
    private final String Jazz_IntegritySalt   = "1u918ye745";

    private static final String paymentReturnUrl="http://localhost/order.php";

    ImageView jazzCashBackIcon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView = (WebView) findViewById(R.id.jazz_cash_web_view);
        jazzCashBackIcon = findViewById(R.id.buyer_jazz_cash_back_icon);
        // Enable Javascript
        ...
        String pp_Description = "Online Purchasing from IB Express";
    ...
    private class FormDataInterface {
        ...
        public void processFormData(String url, String formData) {
            Intent i = new Intent(JazzCash.this, BuyerOrderPaymentTypeActivity.class);
