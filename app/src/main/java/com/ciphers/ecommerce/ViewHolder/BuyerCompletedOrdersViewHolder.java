...
public class BuyerCompletedOrdersViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

    public TextView sellerOrderPriceCV, sellerOrderTitleCV, sellerOrderQtyCV, sellerOrderBuyerNameCV, sellerOrderStatusCV, sellerOrderTotalPriceCV, sellerOrderTypeCV,
            sellerOrderDateCV, sellerOrderShippingIDCV, sellerOrderTrackingIDCV, sellerOrderPaymentType;
    public ImageView sellerOrderImageCV;
    public itemClickListener itemClickListener;

    public BuyerCompletedOrdersViewHolder(@NonNull View itemView) {
        super(itemView);
        ...
        sellerOrderPaymentType = itemView.findViewById(R.id.seller_order_payment_type);

    }

    public void setItemClickListener(com.ciphers.ecommerce.Interface.itemClickListener listener) {
