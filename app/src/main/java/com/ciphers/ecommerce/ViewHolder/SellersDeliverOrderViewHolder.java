...
public class SellersDeliverOrderViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

    public TextView sellerOrderPriceCV, sellerOrderTitleCV, sellerOrderQtyCV, sellerOrderBuyerNameCV,
            sellerOrderStatusCV, sellerOrderTotalPriceCV, sellerOrderTypeCV, sellerOrderDateCV, sellerOrderShippingIDCV,
            sellerOrderTrackingIDCV, sellerOrderPaymentCV;
    public ImageView sellerOrderImageCV;
    public com.ciphers.ecommerce.Interface.itemClickListener itemClickListener;

    public SellersDeliverOrderViewHolder(@NonNull View itemView) {
        super(itemView);
        ...
        sellerOrderPaymentCV = itemView.findViewById(R.id.seller_order_payment_type);
