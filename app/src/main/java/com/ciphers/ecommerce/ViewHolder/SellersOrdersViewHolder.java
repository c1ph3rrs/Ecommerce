...
public class SellersOrdersViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

    public TextView sellerOrderPriceCV, sellerOrderTitleCV, sellerOrderQtyCV, sellerOrderBuyerNameCV, sellerOrderStatusCV,
            sellerOrderTotalPriceCV, sellerOrderTypeCV, sellerOrderDateCV, sellerOrderShippingIDCV,
            sellerOrderTrackingIDCV, sellerOrderPaymentType;
    public ImageView sellerOrderImageCV;
    public itemClickListener itemClickListener;

    public SellersOrdersViewHolder(@NonNull View itemView) {
        super(itemView);
